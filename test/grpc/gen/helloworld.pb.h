...
class HelloRequest PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:helloworld.HelloRequest) */
{
  public:
    ...
    HelloRequest(HelloRequest &&from) noexcept : HelloRequest()
    {
        *this = ::std::move(from);
    }
    ...
    {
        return reinterpret_cast<const HelloRequest *>(&_HelloRequest_default_instance_);
    }
...
class HelloReply PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:helloworld.HelloReply) */
{
  public:
    ...
    HelloReply(HelloReply &&from) noexcept : HelloReply()
    {
        *this = ::std::move(from);
    }
    ...
    {
        return reinterpret_cast<const HelloReply *>(&_HelloReply_default_instance_);
    }
...
inline void HelloReply::set_message(std::string &&value)
{
    ...
    message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
...
inline void HelloReply::set_message(const char *value, size_t size)
{
    ...
    message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(reinterpret_cast<const char *>(value), size), GetArena());
